                    ...
                    <div class="mt-5 flex flex-col items-center space-y-2 justify-center">
                        ...
                        <div class="text-center">
                            ...
                            <h1 class="font-bold text-xs uppercase text-gray-600">
                                {{ auth()->user()->municipality->name }}</h1>
                        </div>
                    </div>
                    <div class="flex flex-col flex-grow px-4 mt-5">
                        <nav class="flex-1 space-y-1 ">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a class="{{ request()->routeIs('municipal.tourist-spots') ? 'bg-white text-green-600' : '' }} inline-flex items-center w-full px-4 py-2 mt-1 text-sm text-gray-500 transition duration-200 ease-in-out transform rounded-lg focus:shadow-outline hover:bg-gray-100 hover:scale-95 hover:text-green-500"
                                        href="{{ route('municipal.tourist-spots') }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-4 w-4"
                                            fill="currentColor">
                                            <path
                                ...
                                <li>
                                    <a class="{{ request()->routeIs('municipal.reports') ? 'bg-white text-green-600' : '' }} inline-flex items-center w-full px-4 py-2 mt-1 text-sm text-gray-500 transition duration-200 ease-in-out transform rounded-lg focus:shadow-outline hover:bg-gray-100 hover:scale-95 hover:text-green-500"
                                        href="{{ route('municipal.reports') }}">
            ...
            <main class="relative flex-1 overflow-y-auto focus:outline-none">
                <div class="py-6">
                    <div class="px-20 mx-auto relative">
                        <header>
                            <h1 class="font-bold text-2xl text-white">@yield('title')</h1>
                        </header>
                        <div class="mt-10">
                            {{ $slot }}
                        </div>
