    ...
    <div x-show="modal" class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <!--
          ...
          Leaving: "ease-in duration-200"
            ...
            To: "opacity-0"
        -->
        <div x-show="modal" class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity"></div>
        ...
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
            ...
            -->
                <div x-show="modal"
                    ...
                    <div class="bg-white px-4 pb-4 py-5 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                <h3 class="text-base font-semibold leading-6 text-gray-900" id="modal-title">
                                    Account has not been Approve!</h3>
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">Please wait for the approval to begin your
                                        transction. Thank you.</p>
                                </div>
                            </div>
                        </div>
                    </div>
